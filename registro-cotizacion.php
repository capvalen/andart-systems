			...
			<div class="col-12 col-lg-6 mx-auto">
				...
				<div class="card">
					<div class="card-body">
						...
						<textarea name="" rows="3" class="form-control" v-model="evento.lugar"></textarea>
						<label for="">Agrupacion <span class="text-danger">*</span></label>
...
<script>
	...
	createApp({
		setup() {
			...
			const evento = ref({ fecha: moment().format('YYYY-MM-DD'), lugar: '', agrupacion: -1, direccion: '', duracion: 2, horario: 0, hora: '12:00', observaciones: ''  })
			...
			function confirmar(){
				...
				else if(!evento.value.fecha || !evento.value.lugar || evento.value.agrupacion==-1 || !evento.value.direccion){ alert('Debe rellenar obligatorios del evento')}
